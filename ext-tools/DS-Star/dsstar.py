...
from provider import ModelProvider, GeminiProvider, OllamaProvider, OpenAIProvider, OpenRouterProvider

# =============================================================================
# CONFIGURATION & PROMPT TEMPLATES
# =============================================================================

# Load prompt.yaml from DS-Star directory (not current working directory)
_DSSTAR_DIR = Path(__file__).parent
with open(_DSSTAR_DIR / "prompt.yaml", "r") as f:
